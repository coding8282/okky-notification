...
public class EmotedNotiTest extends TestMother {
    @Test
    public void wasEmotedByOthers_게시글_작성자가_자신의_게시글을_공감했다면_false() {
        EmotedNoti noti = fixture("m", "m");

        assertFalse("게시글 작성자가 자신의 게시글을 공감했다면 false여야 한다.", noti.wasEmotedByOthers());
    }

    @Test
    public void wasEmotedByOthers_다른_사람이_게시글_작성자의_게시글을_공감했다면_true() {
        EmotedNoti noti = fixture("m", "x");

        assertTrue("게시글 작성자가 자신의 게시글을 공감했다면 false여야 한다.", noti.wasEmotedByOthers());
    }
