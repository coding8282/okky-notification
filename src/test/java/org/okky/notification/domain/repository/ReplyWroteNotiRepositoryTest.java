...
public class ReplyWroteNotiRepositoryTest extends TestMother {
    ...
    public void findByOwnerId() {
        ...
        List<ReplyWroteNoti> notis = repository.findByOwnerId("m-1");
    ...
    public void findByOwnerId_첫번째_페이징() {
        ...
        Page<ReplyWroteNoti> page = repository.findByOwnerId("m-1", PageRequest.of(0, 5));
    ...
    public void findByOwnerId_마지막_페이징() {
        ...
        Page<ReplyWroteNoti> page = repository.findByOwnerId("m-1", PageRequest.of(1, 5));
    ...
    public void findByOwnerId_없는_페이지_페이징() {
        ...
        Page<ReplyWroteNoti> page = repository.findByOwnerId("m-1", PageRequest.of(100, 5));
