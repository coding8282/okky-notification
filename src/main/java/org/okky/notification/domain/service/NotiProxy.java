...
import org.okky.notification.domain.model.*;
...
public class NotiProxy {
    ...
    public Scrapper fetchScrapper(String scrapperId) {
        String url = "/members/" + scrapperId;
        return template.getForEntity(url, Scrapper.class).getBody();
    }
